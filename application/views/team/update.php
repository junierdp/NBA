...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="<?php echo base_url('team/update');?>" enctype="multipart/form-data" autocomplete="off" required>
				<div class="col-md-6">
					<div class="form-group input-group">
						<span class="input-group-addon">ID:</span>
						<input type="text" name="teamID" class="form-control" value="<?php echo $team->teamID?>" readonly>
					</div>
					<div class="form-group input-group">
						<span class="input-group-addon">Name:</span>
						<input type="text" name="teamName" class="form-control" value="<?php echo $team->name?>">
					</div>
					<div class="form-group input-group">
						<span class="input-group-addon">City:</span>
						<input type="text" name="city" class="form-control" value="<?php echo $team->city?>">
					</div>
