...
<body>
	...
	<div class="container">
		<div class="row col-md-offset-2">
			<form method="post" action="<?php echo base_url('player/update');?>" autocomplete="off" required enctype="multipart/form-data">
				<div class="col-md-9">
					<div class="form-group input-group has-success">
						<span class="input-group-addon">ID:</span>
						<input type="text" name="playerID" class="form-control input-lg" value="<?php echo $player->playerID?>" readonly>
					</div>
					<div class="form-group input-group has-success">
						<span class="input-group-addon">Name:</span>
						<input type="text" name="name" class="form-control input-lg" value="<?php echo $player->name?>" required>
					</div>
					<div class="form-group input-group has-success">
						<span class="input-group-addon">Nickname:</span>
						<input type="text" name="nickname" class="form-control input-lg" value="<?php echo $player->nickname?>" required>
					</div>
					...
					<div class="form-group input-group has-success">
						...
						<select name="teamID" class="form-control input-lg">
					...
					<div class="form-group input-group has-success">
						...
						<input type="text" name="position" class="form-control input-lg" value="<?php echo $player->position?>" required>
					</div>
					<div class="form-group input-group has-success">
						<span class="input-group-addon">Number:</span>
						<input type="number" name="number" class="form-control input-lg" value="<?php echo $player->number?>" required>
					</div>
